...
setwd("~/Documents/GitHub/semestre5_git/econometria_2_personal/monitorias/2020_2/Sesión 10 de Monitoria - Modelos Multiecuaciones (VAR)/2_datos")
...
# convencional porque los residuales no son normales, por ende hay que ahcer bootstrapping
